...
namespace CoinMarketCap.Core
{
    ...
    public interface ICoinMarketCapClient : IDisposable
    {
        ...
        /// <returns></returns>
        Task<List<Entities.TickerEntity>> GetTickerListAsync(int? limit = null,
            Enums.ConvertEnum convert = Enums.ConvertEnum.USD);
        /// <summary>
        ...
        /// <param name="convert">Convert the crypto volumes to the given Fiat currency.</param>
        /// <returns></returns>
        Task<Entities.TickerEntity> GetTickerAsync(string cryptoCurrency,
            Enums.ConvertEnum convert = Enums.ConvertEnum.USD);
        ...
        Task<Entities.GlobalDataEntity> GetGlobalDataAsync(Enums.ConvertEnum convert = Enums.ConvertEnum.USD);
    }
}
